#!/usr/bin/env python3
"""
OMIS 105 — Software Setup & Verification Script (Mac)
=======================================================
...
HOW TO RUN
----------
  Open Terminal, then type:     python3 step_2_setup_software.py
"""
...
def is_externally_managed(result):
    ...
    Homebrew Python blocks plain 'pip install' this way. It is a
    safety rule about the computer's own Python, not a problem with
...
def install_packages():
    ...
    for pkg in packages:
        ...
        # Homebrew Python refuses a plain install to protect the
        # system Python. Retry in the one way that works, and explain
        # it in plain language the first time.
