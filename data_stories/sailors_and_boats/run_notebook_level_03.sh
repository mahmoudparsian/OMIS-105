#!/usr/bin/env bash
#
# Open the Sailors & Boats notebook -- Level 3: ten intermediate+ queries.
#
#   ./run_notebook_level_03.sh                          # the project's own database
#   ./run_notebook_level_03.sh /path/to/other.duckdb    # any other database
#   ./run_notebook_level_03.sh demo.duckdb --port 2719
#
# Covers: INTERSECT / EXCEPT, anti-joins, CASE, date arithmetic, ranking windows.
#
...
open_notebook notebooks/notebook_level_03.py "$@"
