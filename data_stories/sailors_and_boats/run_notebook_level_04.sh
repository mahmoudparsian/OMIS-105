#!/usr/bin/env bash
#
# Open the Sailors & Boats notebook -- Level 4: ten advanced queries.
#
#   ./run_notebook_level_04.sh                          # the project's own database
#   ./run_notebook_level_04.sh /path/to/other.duckdb    # any other database
#   ./run_notebook_level_04.sh demo.duckdb --port 2719
#
# Covers: relational division, window functions, PIVOT, a recursive calendar.
#
...
open_notebook notebooks/notebook_level_04.py "$@"
